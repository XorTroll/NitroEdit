...
namespace ui {
    ...
    struct Sprite {
        ...
        bool CreateFrom(const bool is_sub, const int x, const int y, const std::string &path, std::shared_ptr<ntr::fs::FileHandle> file_handle) {
            this->Dispose();
        ...
        bool CreateFrom(const bool is_sub, const int x, const int y, const ntr::gfx::abgr1555::Color *gfx_buf, const u32 width, const u32 height, const bool owns_gfx_buf = false) {
            this->Dispose();
            this->gfx_buf = const_cast<ntr::gfx::abgr1555::Color*>(gfx_buf);
        ...
        inline bool CreateLoadFrom(const bool is_sub, const int x, const int y, const std::string &path, std::shared_ptr<ntr::fs::FileHandle> file_handle) {
        ...
        inline bool CreateLoadFrom(const bool is_sub, const int x, const int y, const ntr::gfx::abgr1555::Color *gfx_buf, const u32 width, const u32 height, const bool owns_gfx_buf = false) {
        ...
        inline void SetPixel(const int x, const int y, const C clr) {
            ...
            this->sprites[i].gfx_ptr[(y % BaseSpriteSizeValue) * BaseSpriteSizeValue + (x % BaseSpriteSizeValue)].raw_val = ntr::gfx::ConvertColor<C, ntr::gfx::abgr1555::Color>(clr).raw_val;
        }
