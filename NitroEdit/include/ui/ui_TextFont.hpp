...
namespace ui {
    ...
    struct TextFont {
        ...
        bool RenderTextBase(const std::string &text, const u32 x, const u32 y, const u32 line_height, const u32 max_line_width, const bool is_sub, const ntr::gfx::abgr1555::Color clr, const bool centered, Sprite &out_spr);
