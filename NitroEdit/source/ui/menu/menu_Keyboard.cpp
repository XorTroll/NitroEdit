...
namespace ui::menu {
    ...
    namespace {
        ...
        inline void UpdateText(const std::string &text) {
            ...
            ASSERT_TRUE(GetTextFont().RenderText(text_copy, 12, 12, NormalLineHeight, 232, true, ntr::gfx::abgr8888::BlackColor, false, g_KeyboardText));
    ...
    void InitializeKeyboard() {
        ...
        ASSERT_TRUE(LoadPNGGraphics("ui/kbd.png", CreateSelfNitroFsFileHandle(), w1, h1, g_KeyboardGfx));
        ASSERT_TRUE(LoadPNGGraphics("ui/kbd_pressed.png", CreateSelfNitroFsFileHandle(), w2, h2, g_KeyboardPressedGfx));
        ASSERT_TRUE(w1 == w2);
        ASSERT_TRUE(h1 == h2);

        ASSERT_TRUE(LoadPNGGraphics("ui/kbd_caps.png", CreateSelfNitroFsFileHandle(), w1, h1, g_KeyboardCapsGfx));
        ASSERT_TRUE(LoadPNGGraphics("ui/kbd_caps_pressed.png", CreateSelfNitroFsFileHandle(), w2, h2, g_KeyboardCapsPressedGfx));
        ASSERT_TRUE(w1 == w2);
        ASSERT_TRUE(h1 == h2);

        ASSERT_TRUE(LoadPNGGraphics("ui/kbd_shift.png", CreateSelfNitroFsFileHandle(), w1, h1, g_KeyboardShiftGfx));
        ASSERT_TRUE(LoadPNGGraphics("ui/kbd_shift_pressed.png", CreateSelfNitroFsFileHandle(), w2, h2, g_KeyboardShiftPressedGfx));
        ASSERT_TRUE(w1 == w2);
        ASSERT_TRUE(h1 == h2);
