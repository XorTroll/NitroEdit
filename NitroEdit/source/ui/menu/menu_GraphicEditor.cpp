...
namespace ui::menu {
    ...
    void InitializeGraphicEditor() {
        ASSERT_TRUE(LoadPNGGraphics("ui/gfx_editor_bg.png", CreateSelfNitroFsFileHandle(), g_GfxBgWidth, g_GfxBgHeight, g_GfxBgBuf));

        ASSERT_TRUE(g_PaletteSelectBox.CreateFrom(false, 0, 0, "ui/plt_select_box.png", CreateSelfNitroFsFileHandle()));
    }
