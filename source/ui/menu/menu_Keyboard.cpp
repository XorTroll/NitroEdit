...
namespace ui::menu {
    ...
    namespace {
        ...
        ntr::gfx::abgr1555::Color *g_KeyboardGfx = nullptr;
        ntr::gfx::abgr1555::Color *g_KeyboardPressedGfx = nullptr;
        ntr::gfx::abgr1555::Color *g_KeyboardCapsGfx = nullptr;
        ntr::gfx::abgr1555::Color *g_KeyboardCapsPressedGfx = nullptr;
        ntr::gfx::abgr1555::Color *g_KeyboardShiftGfx = nullptr;
        ntr::gfx::abgr1555::Color *g_KeyboardShiftPressedGfx = nullptr;

        ntr::gfx::abgr1555::Color *g_KeyboardCurrentGfx = nullptr;
        ntr::gfx::abgr1555::Color *g_KeyboardCurrentPressedGfx = nullptr;
        ...
        inline void UpdateText(const std::string &text) {
            ...
            ASSERT_SUCCESSFUL(GetTextFont().RenderText(text_copy, 12, 12, NormalLineHeight, 232, true, ntr::gfx::abgr8888::BlackColor, false, g_KeyboardText));
            ASSERT_SUCCESSFUL(g_KeyboardText.Load());
        }
        ...
        void ChangeMode(const KeyboardMode new_mode) {
            ...
            std::memcpy(g_Keyboard.gfx_buf, g_KeyboardCurrentGfx, g_KeyboardWidth * g_KeyboardHeight * sizeof(ntr::gfx::abgr1555::Color));
            g_Keyboard.Refresh();
        }
        ...
        void LoadKeyFrom(ntr::gfx::abgr1555::Color *kbd_buf, const KeyboardKey &key) {
    ...
    void InitializeKeyboard() {
        ...
        ASSERT_SUCCESSFUL(LoadPNGGraphics("ui/kbd.png", CreateSelfNitroFsFileHandle(), w1, h1, g_KeyboardGfx));
        ASSERT_SUCCESSFUL(LoadPNGGraphics("ui/kbd_pressed.png", CreateSelfNitroFsFileHandle(), w2, h2, g_KeyboardPressedGfx));
        ASSERT_TRUE(w1 == w2);
        ASSERT_TRUE(h1 == h2);

        ASSERT_SUCCESSFUL(LoadPNGGraphics("ui/kbd_caps.png", CreateSelfNitroFsFileHandle(), w1, h1, g_KeyboardCapsGfx));
        ASSERT_SUCCESSFUL(LoadPNGGraphics("ui/kbd_caps_pressed.png", CreateSelfNitroFsFileHandle(), w2, h2, g_KeyboardCapsPressedGfx));
        ASSERT_TRUE(w1 == w2);
        ASSERT_TRUE(h1 == h2);

        ASSERT_SUCCESSFUL(LoadPNGGraphics("ui/kbd_shift.png", CreateSelfNitroFsFileHandle(), w1, h1, g_KeyboardShiftGfx));
        ASSERT_SUCCESSFUL(LoadPNGGraphics("ui/kbd_shift_pressed.png", CreateSelfNitroFsFileHandle(), w2, h2, g_KeyboardShiftPressedGfx));
        ASSERT_TRUE(w1 == w2);
        ASSERT_TRUE(h1 == h2);
    ...
    bool ShowKeyboard(const KeyboardContext &ctx, std::string &text) {
        ...
        auto kbd_gfx = ntr::util::NewArray<ntr::gfx::abgr1555::Color>(g_KeyboardWidth * g_KeyboardHeight);
        ASSERT_SUCCESSFUL(g_Keyboard.CreateLoadFrom(true, 5, 106, kbd_gfx, g_KeyboardWidth, g_KeyboardHeight, true));
