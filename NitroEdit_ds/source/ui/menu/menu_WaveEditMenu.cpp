        ...
        g_MenuEntries = {
            {
                ...
                .on_select = []() {
                    ...
                    const auto rc = swar.ReadSampleData(g_Sample, sample_data);
                    if(rc.IsSuccess()) {
                        ...
                        switch(res) {
                            case DialogResult::Yes: {
                                ...
                                RunWithDialog("Saving recorded sample...", [&]() {
                                    rc = swar.WriteSampleData(g_Sample, g_RecordedSoundData, g_RecordedSoundDataOffset, std::make_shared<ntr::fmt::SDATFileHandle>(sdat));
                                });
                                if(rc.IsSuccess()) {
